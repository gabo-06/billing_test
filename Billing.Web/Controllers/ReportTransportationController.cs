...
namespace Billing.Web.Controllers
{
    public class ReportTransportationController : Controller
    {
        ...
        public ReportTransportationController()
        { 
            this._HtmlViewRenderer = new HtmlViewRenderer();
            this.StandardPdfRenderer = new StandardPdfRenderer();
        }

        public PartialViewResult listaTransportation()
        {
            List<SP_REPORT_TRANSPORTATION_Result> Listado;
            Listado = model.ReporteTransportation();
        ...
        public ActionResult ExportToWordTransportation(String invoice = "", String DOI = "", String patient = "")
        {
            ...
            strBody = strBody + "<tr><td colspan=4 style='text-align:center; font-weight:bold;width:100px;font-size: 25px;font-family: sans-serif;'>TRANSPORTATION REPORTS</td></tr></table>";
            ...
            string nombre_archivo = "Transportation_report-" + fechaActual; 

            //string htmlString = this.RenderRazorViewToString(@"TestPartialViewWithModel", DetalleDeFactura);
            string htmlString = this.RenderRazorViewToString(@"listaTransportation", Listado);
