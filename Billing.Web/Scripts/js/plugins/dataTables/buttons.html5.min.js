...
"Excel")
        ...
        var e = 0, a = function (a) { return i.parseXML(z[a]) }, f = a("xl/worksheets/sheet1.xml"), h = f.getElementsByTagName("sheetData")[0], a = { _rels: { ".rels": a("_rels/.rels") }, xl: { _rels: { "workbook.xml.rels": a("xl/_rels/workbook.xml.rels") }, "workbook.xml": a("xl/workbook.xml"), "styles.xml": a("xl/styles.xml"), worksheets: { "sheet1.xml": f } }, "[Content_Types].xml": a("[Content_Types].xml") }, c = c.buttons.exportData(b.exportOptions), m, k, d = function (a) {
            m = e + 1; k = n(f, "row", { attr: { r: m } });
            for (var b = 0,
c = a.length; b < c; b++) {
                for (var d = b, g = ""; 0 <= d;) g = String.fromCharCode(d % 26 + 65) + g, d = Math.floor(d / 26) - 1; var d = g + "" + m, j = null;
                if (!(null === a[b] || a[b] === p || "" === a[b])) {
                    ...
                    for (var l = 0, o = H.length; l < o; l++)
                        ...
                        attr: { t: "n", r: d }, children: [n(f,"v", { text: a[b] })]
        ...
        var fila = "";
        if (b.message) {
            var line = b.message.split('\n');
            console.log(line);
            /////var tab = [];
            ///////for (var i in line) {
            for (xx = 0 ; xx < jQuery(line).size() ; xx++) {
                tab = line[xx].split('\t');
                console.log(tab);
                //c.header += tab;
            };
        ...
        for (var j = 0, l = c.body.length; j < l; j++)
            d(c.body[j], e);
...
b.customize && b.customize(a, b); c = (r || g.pdfMake).createPdf(a); "open" === b.download && !G() ? c.open() : c.getBuffer(function (a) { a = new Blob([a], { type: "application/pdf" }); o(a, u(b)) })
